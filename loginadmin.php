...
<head>
    ...
    <title>Login Admin Kholis Coffee</title>
...
<body class="text-center" style="background-color: #DFB78C;">
    ...
    <main class="form-signin w-100 m-auto">
        <form class="needs-validation" novalidate action="prosesloginadmin.php" method="post">
            ...
            <button class="w-100 btn btn-lg btn-primary" type="submit" name="submit_validate" value="abc" style="background-color: #49281A; border: none;">
                LOGIN
            </button>
        </form>
    </main>
